...
```{r}
#Création de mobil sans les Week 
...
plot(mobil_nw_ts1b, 
     main = "Série journalière aggrégée (week) = NA)", xlab = "Temps [année]",
     ylab = "Mobilité vers les lieux de travail (% par rapport à la référence)")
```
...
plot(mobil_nwe_ts1, 
     main = "Série journalière (week = NA)", xlab = "Temps [année]",
     ylab = "Mobilité vers les lieux de travail (% par rapport à la référence)")
...
legend("topright", 
       legend = c("Série originale", "Série journalière aggrégée (week-ends = NA)", "Série journalière aggrégée (week = NA)" ), 
